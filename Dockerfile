...
RUN apt-get install -y git mercurial wget vim \
  autoconf bzr cvs unrar build-essential clang \
  valgrind gsl-bin libgsl2 libgsl-dev flex \ 
  bison libfl-dev tcpdump sqlite sqlite3 \
  libsqlite3-dev libxml2 libxml2-dev vtun lxc
